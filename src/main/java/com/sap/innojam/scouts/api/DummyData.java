...
public class DummyData {
	...
	public static Scout scott = new Scout("uid", "artistName", "Scott", "Scoutsen", 35, "m", "scott@scoutsen.com", null, null);
	...
	public static Talent dummyTalent = new Talent("ted@talent.com");
