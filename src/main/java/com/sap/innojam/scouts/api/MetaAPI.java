...
public class MetaAPI {
	...
	private final static String[] CLOUD_ENV_VARS = { "HC_HOST", "HC_REGION",
			"HC_ACCOUNT", "HC_APPLICATION", "HC_APPLICATION_URL",
			"HC_LOCAL_HTTP_PORT", "HC_LANDSCAPE", "HC_PROCESS_ID",
			"HC_OP_HTTP_PROXY_HOST", "HC_OP_HTTP_PROXY_PORT" };
